...
def dst80_merge(keyl,keyr):
    keyl = p2(keyl)
    keyr = p2(keyr)
    if bit(keyl,39): keyl ^= 0x7fffffffff
    if bit(keyr,39): keyr ^= 0x7fffffffff
...
# ---------------------------
# Test vector added for verification
# ---------------------------
if __name__ == '__main__':
    # Prints a test signature for manual comparison
    print(hex(dst80(0x079E70AAAA, 0xAAAAF51886, 0xC212345678)))
